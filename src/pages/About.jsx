    ...
    <div className="bg-gray-50 text-gray-800 min-h-screen py-20 font-sans">
      ...
      >
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, delay: 0.4 }}
            className="bg-white/50 h-full py-16 rounded-2xl shadow-xl flex items-center justify-center p-8 text-white relative overflow-hidden"
          >
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            {values.map((value, index) => (
              ...
              >
                <div className="group-hover:scale-105 group-hover:drop-shadow-2xl duration-200 transition-all ease-in-out w-12 h-12  bg-blue-600 text-blue-600 rounded-lg flex items-center justify-center mb-4">
                  {value.icon}
                </div>
      ...
      <section className="py-16 bg-gray-50">
        <motion.div
          ...
          className="max-w-4xl mx-auto px-4 grid grid-cols-3 gap-4 text-center"
        >
